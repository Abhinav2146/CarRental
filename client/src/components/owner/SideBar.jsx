  ...
  return (
    ...
    >
      <div className="group relative">
        <label htmlFor="image">
          <img
            className="h-10 md:h-20 w-9 md:w-18 rounded-full mx-auto"
          ...
          />
          <div
            className="absolute hidden top-0 right-0 left-0 bottom-0 bg-black/10 rounded-full group-hover:flex items-center
